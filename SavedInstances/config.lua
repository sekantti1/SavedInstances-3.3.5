		...
		args = {
			General = {
				...
				args = {
					...
					Currency301 = { -- Emblem of Triumph
						type = "toggle",
						order = 51,
						name = L["Track"] .. " " .. "Emblem of Triumph",
					},
					Currency341 = { -- Emblem of Frost
						type = "toggle",
						order = 52,
						name = L["Track"] .. " " .. "Emblem of Frost",
					},
					Currency101 = { 
						type = "toggle",
						order = 52,
						name = L["Track"] .. " " .. "Emblem of Heroism",
					},
					Currency102 = { 
						type = "toggle",
						order = 52,
						name = L["Track"] .. " " .. "Emblem of Valor",
					},
					Currency221 = { 
						type = "toggle",
						order = 52,
						name = L["Track"] .. " " .. "Emblem of Conquest",
					},
					Currency392 = { -- Honor Points
						type = "toggle",
						order = 53,
						name = L["Track"] .. " " .. "Honor Points",
					},
